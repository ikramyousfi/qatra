            ...
            <div class="col-md-4 offset-md-3 login" style="margin-top: 80px;">
                ...
                <form action="{{ route('user.check') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control " name="password" placeholder="Entrez votre mot de passe" value="{{ old('password') }}">
                    ...
                    <br>
                    <a href="{{ route('gestionnaire.login') }}" class="link-secondary">Se connecter au tant que gestionnaire</a>
                </form>
            </div>
        </div>
    </div>
