...
@section('content')
  ...
  <div class="row">
    ...
    <div class="w30 object-fit"><a href="#"><img src="{{ asset('photo/B.png') }}" alt="pic1" width="640" height="478"> </a></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="w30 object-fit"><a href="#"><img src="{{ asset('photo/Qatra-noir.ico') }}" alt="pic1" width="640" height="478"> </a></div>
  </div>
  ...
  <div class="row">
    <div class="w60 textbox-1">
        <div class="inner">
                ...
                <p>La première chose a faire est de vous connecter.Vous allez avoir par la suite deux choix,
